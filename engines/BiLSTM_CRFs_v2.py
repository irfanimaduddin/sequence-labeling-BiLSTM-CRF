...
class BiLSTM_CRFs(object):
    ...
    def train(self):
        ...
        train_writer = tf.compat.v1.summary.FileWriter(self.logdir + "/training_loss", self.sess.graph)
        dev_writer = tf.compat.v1.summary.FileWriter(self.logdir + "/validating_loss", self.sess.graph)
